...
import (
	...
	"github.com/schaepher/mobile/internal/importers/java"
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/schaepher/mobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/schaepher/mobile/bind/testdata/benchmark"}, "", "SeqBench")
}
