...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/schaepher/mobile/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/schaepher/mobile", "github.com/schaepher/mobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/schaepher/mobile", "github.com/schaepher/mobile", 2},
		{"ffffffff t github.com/example/github.com/schaepher/mobile", "", 0},
		{"ffffffff t github.com/example/repo", "", 0},
		{"ffffffff t github.com/example/repo/vendor", "", 0},
		{"ffffffff t _github.com/schaepher/mobile/app", "github.com/schaepher/mobile/app", 2},
	}
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/schaepher/mobile/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
