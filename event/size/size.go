...
//
// See the github.com/schaepher/mobile/app package for details on the event model.
package size // import "github.com/schaepher/mobile/event/size"

import (
	"image"

	"github.com/schaepher/mobile/geom"
)
...
type Event struct {
	...
	// pixels in a single geom.Pt, from the github.com/schaepher/mobile/geom package.
	//
